 ...
 * use admin route that will check whether the user is admin or not if not admin than redirect to any other page. you could logout user and send them to the login page as well.
 * 
 * 
 * -----------------------------
 * 
